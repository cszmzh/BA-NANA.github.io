...
categories: 技术
tags: Python3
cover: 'https://s1.51cto.com/images/blog/201903/29/c6b3a207ac4b48efc91590b24ab7052f.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk='
comments: true
toc: true
---
...
* **字符串**
  ...
  * **字符串的运算**
    ...
    总结：可以当做初始时光标在头部，括号里面的数字代表光标移动的次数

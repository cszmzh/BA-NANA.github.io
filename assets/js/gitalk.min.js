...
function imgerrorfun(){
    console.log(CheckImgExists("https://ba-nana.github.io/assets/img/defaultHeadImage.png"));
    var img = document.getElementsByClassName("gt-comment-avatar")[0];
    console.log(document.getElementsByClassName("gt-comment-avatar")[0]);
    if(CheckImgExists("https://ba-nana.github.io/assets/img/defaultHeadImage.png")==false){
        document.getElementsByClassName("gt-comment-avatar")[0].setAttribute("src","https://ba-nana.github.io/assets/img/defaultHeadImage.png");

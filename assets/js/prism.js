/* PrismJS 1.19.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+c+csharp+cpp+coffeescript+cmake+diff+git+go+java+javadoc+javadoclike+javastacktrace+json+kotlin+markdown+markup-templating+nginx+objectivec+php+phpdoc+php-extras+python+regex+ruby+sql+swift+typescript&plugins=line-numbers+autolinker+toolbar+copy-to-clipboard */
